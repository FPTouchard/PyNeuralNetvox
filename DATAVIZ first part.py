...
to end this first part, a summary table of durations and ratios for all the channels on the whole DSD100 datasetPour se faire une idée de la composition d'un morceau à partir des signaux respectifs, nous avons défini une fonction permettant de déterminer le temps d'une source et par répercussion sa proportion par rapport au morceau complet. Pour ce faire, nous déterminons le nombre de points non nul du signal audio et connaissant la fréquence d'échantillonnage, nous en tirons une durée approchée
# In[39]:
